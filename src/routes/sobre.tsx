...
const valores = [
  { title: "Inovação", text: "Estagnar significa perder oportunidades. Buscamos novos caminhos a cada projeto.", shape: "sparkle" as const, color: "var(--brand-amber)" },
  { title: "Aprimoramento", text: "Mudar é necessário e faz parte de qualquer adaptação — evoluímos junto do mercado.", shape: "burst" as const, color: "var(--brand-magenta)" },
  { title: "Saúde empresarial", text: "Uma vivência empresarial mais constante, sustentável e saudável para o time.", shape: "flower" as const, color: "var(--brand-green)" },
  { title: "Qualidade", text: "Projetos de alta qualidade entregues do começo ao fim, com método e transparência.", shape: "hex" as const, color: "var(--brand-lime)" },
];
  ...
  return (
    <div>
      ...
      <section className="border-y border-border bg-muted/40">
        <div className="mx-auto max-w-6xl px-5 py-20">
          <h2 className="headline text-4xl text-brand-forest md:text-5xl">No que acreditamos</h2>
